...
public class HiveTest {  
    ...
    private static String url = "jdbc:hive2://hadoop02:10000/data";  
    ...
    public static void main(String[] args) {  
        ...
        try {  
            ...
            // 第一步:存在就先删除  
            String tableName = "testHive";//dropTable(stmt);  
...
//            loadData(stmt, tableName);  
    ...
    private static void loadData(Statement stmt, String tableName)  
            throws SQLException {  
        String filepath = "/usr/hdp/2.3.4.0-3485/hive/data/data";  
